...
PATH_TEST = "./training/images/test/"
PATH_RECORD_TEST = "./training/test.record"
PATH_TRAIN = "./training/images/train/"
PATH_RECORD_TRAIN = "./training/train.record"
...
def xml_to_tf(path_input, path_output):
    ...
    for file in files:
        if file.endswith(".xml"):
            ...
            filename = root.find('filename').text + IMAGE_EXT
